...
namespace ProjetoSalaoDeBeleza.Migrations
{
    ...
    [Migration("20260411191917_PagesIniciais")]
    partial class PagesIniciais
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ProjetoSalaoDeBeleza.Models.Cidades", b =>
                {
                    ...
                    b.Property<int>("oEstadoCodEstado")
                        .HasColumnType("integer");

                    b.HasKey("CodCidade");

                    b.HasIndex("oEstadoCodEstado");
            ...
            modelBuilder.Entity("ProjetoSalaoDeBeleza.Models.Estados", b =>
                {
                    ...
                    b.Property<int>("oPaisCodPais")
                        .HasColumnType("integer");

                    b.HasKey("CodEstado");

                    b.HasIndex("oPaisCodPais");
            ...
            modelBuilder.Entity("ProjetoSalaoDeBeleza.Models.Cidades", b =>
                {
                    b.HasOne("ProjetoSalaoDeBeleza.Models.Estados", "oEstado")
                        .WithMany()
                        .HasForeignKey("oEstadoCodEstado")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
